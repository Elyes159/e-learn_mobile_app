...
class ExLeconSix extends StatefulWidget {
  const ExLeconSix({super.key});

  @override
  _ExLeconSixState createState() => _ExLeconSixState();
}
  ...
  void importQuestionsFromFirestore() async {
    try {
      ...
      QuerySnapshot querySnapshot = await adminCollection
          ...
          .where('chapitre_lecon', isEqualTo: 'bonjour/lecon6')
          .get();
