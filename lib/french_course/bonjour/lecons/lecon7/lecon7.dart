...
class ExLeconSeven extends StatefulWidget {
  const ExLeconSeven({super.key});

  @override
  _ExLeconSevenState createState() => _ExLeconSevenState();
}

class _ExLeconSevenState extends State<ExLeconSeven> {
  @override
  void initState() {
  ...
  void importQuestionsFromFirestoreAdmin() async {
    try {
      ...
      QuerySnapshot querySnapshot = await adminCollection
          ...
          .where('chapitre_lecon', isEqualTo: 'bonjour/lecon7')
          .get();
        ...
        if (_currentPage < questions.length - 1) {
          ...
          if (courseSnapshot.docs.isNotEmpty) {
            setState(() {
              ...
              // et vérifier la valeur actuelle du champ 'lecon7Bonjour'

              // Mettez à jour le champ 'lecon7Bonjour' car il n'est pas encore vrai
              ...
              print('Champ lecon7Bonjour ajouté avec succès!');
            });
          } else {
            // La condition est déjà vraie, vous pouvez faire quelque chose ici si nécessaire
            print('Le champ lecon7Bonjour est déjà vrai!');
          }
        }
      } else {
